...
//                options.inPreferredConfig = Bitmap.Config.ARGB_8888;
                ...
                imgV.setImageBitmap(BitmapFactory.decodeFile("/data/local/tmp/lena.bmp", options));
